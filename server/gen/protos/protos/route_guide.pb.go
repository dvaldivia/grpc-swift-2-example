...
const file_protos_route_guide_proto_rawDesc = "" +
	"\n" +
	...
	"\tRouteChat\x12\x15.routeguide.RouteNote\x1a\x15.routeguide.RouteNote\"\x00(\x010\x01Br\n" +
	"\x1bio.grpc.examples.routeguideB\x0fRouteGuideProtoP\x01Z;github.com/dvaldivia/grpc-swift-2-example/server/gen/protos\x92\x03\x02\b\x02b\beditionsp\xe8\a"

var (
	file_protos_route_guide_proto_rawDescOnce sync.Once
	file_protos_route_guide_proto_rawDescData []byte
)

func file_protos_route_guide_proto_rawDescGZIP() []byte {
	file_protos_route_guide_proto_rawDescOnce.Do(func() {
		file_protos_route_guide_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_protos_route_guide_proto_rawDesc), len(file_protos_route_guide_proto_rawDesc)))
	})
	return file_protos_route_guide_proto_rawDescData
}

var file_protos_route_guide_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_protos_route_guide_proto_goTypes = []any{
...
func file_protos_route_guide_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_protos_route_guide_proto_rawDesc), len(file_protos_route_guide_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
